...
public class Upload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String oname=request.getSession().getAttribute("oname").toString();
		System.out.println("username7777777777777777777"+oname);
				...
				String fullpath=editpath+"Ckeyword\\WebContent\\Local\\";
			...
			//file encrypted and store into filepath1
		                ...
		                try {//try1 open
		        			...
		        			encontent = SHA256.encrypt99(filecontent);
		        				System.out.println("encontent===="+encontent);
		             filepath1 = editpath + "\\Ckeyword\\WebContent\\Encrypt\\"+filename;
		              ...
		              //file decrypted and store into filepath2
		                        String decontent= SHA256.decrypt(encontent);
		        				System.out.println("decontent===="+decontent);
		        		    filepath2 = editpath + "\\Ckeyword\\WebContent\\Decrypt\\"+filename;
		     ...
		     filepath1 = editpath + "\\Ckeyword\\WebContent\\Encrypt\\"+filename;
		      ...
		      //file decrypted and store into filepath2
	                ...
	                upb.setFileowner(oname);
	                System.out.println("uname"+oname);
	                ...
	                upb.setFilekey(paramValues.get(0).toString());
	                System.out.println("Secretkey"+paramValues);
	                ...
	                upb.setFileencrypt(encontent);
	                System.out.println("Encrypted text"+encontent);
	                
	                upb.setFiledecrypt(filecontent);
